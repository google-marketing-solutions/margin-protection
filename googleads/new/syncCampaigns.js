...
function setUpConfigSheets() {
  ...
  var richText = SpreadsheetApp.newRichTextValue()
    .setText("Complete desired included and excluded locations for each campaigns. If no preference for a single campaign, leave blank (empty)")
...
function addCampaignsToConfigSheets(account, campaignsIterator) {
  while (campaignsIterator.hasNext()) {
    ...
    console.log("Found campaign " + campaign.getId() + " - " + campaign.getName());
